(function($) {
    ...
    $(document).ready(function() {
        ...
        // Thus the launchDay below denotes 25th December 2016.
        var launchDay = new Date(2016, 12 - 1, 25);
        $('#timer').countdown({
            until: launchDay
        });
        ...
        $('#newsletter-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.post($(form).attr('action'), $(form).serialize(), function(data) {
                    $('#newsletter .loading').animate({
                        opacity: 0
                    }, function() {
                        $(this).hide();
                        $('#newsletter .success').show().html('<p>Thank you for subscribing!</p>').animate({
                            opacity: 1
                        });
                    });
                });
